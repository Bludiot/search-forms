...
The Search Forms plugin is an improved version of the default Bludit search plugin. It allows for more than one search form on one page, whereas the default plugin does not. Many options are available for customization, and as well as options for developers to code search forms into themes.
